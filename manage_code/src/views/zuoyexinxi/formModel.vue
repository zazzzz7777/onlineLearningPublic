          ...
          <el-col :span="24">
            <el-form-item label="教师姓名" prop="jiaoshixingming">
              <el-input
                ...
                type="text"
                :readonly="
                  !isAdd || disabledForm.jiaoshixingming ? true : false
                "
              />
            </el-form-item>
          </el-col>
...
const getInfo = () => {
  context
    ...
    .then((res) => {
      ...
      res.data.data.zuoyefujian = res.data.data.zuoyefujian
        ? res.data.data.zuoyefujian.replace(reg, '../../../onlineLearning/file')
        : ''
      res.data.data.zuoyeneirong = res.data.data.zuoyeneirong
        ? res.data.data.zuoyeneirong.replace(
            reg,
            '../../../onlineLearning/file'
          )
        : ''
