  ...
  >
    ...
    <div class="detail_view">
      ...
      <div class="info_view">
        ...
        <div class="info_item">
          <div class="info_label">作业类型</div>
          <div class="info_text">{{ detail.zuoyeleixing }}</div>
        </div>
        <div class="info_item">
        ...
        <div class="btn_view">
          <el-button
            class="cross_btn"
            v-if="btnFrontAuth(tableName, '提交')"
            @click="zuoyetijiaoonAcross('提交', 'zuoyetijiao', '', '', '')"
            type="warning"
            >提交</el-button
          >
          <el-button
            class="edit_btn"
            v-if="centerType && btnAuth('zuoyexinxi', '修改')"
            type="primary"
            @click="editClick"
            >修改</el-button
          >
          <el-button
            class="del_btn"
            v-if="centerType && btnAuth('zuoyexinxi', '删除')"
            type="danger"
            @click="delClick"
            >删除</el-button
          >
    ...
    <el-tabs type="border-card" v-model="activeName" class="tabs_view">
      <el-tab-pane label="作业附件" name="first">
        <div v-html="detail.zuoyefujian"></div>
      </el-tab-pane>
      <el-tab-pane label="作业内容" name="first1">
