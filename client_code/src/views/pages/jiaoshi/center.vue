          ...
          <el-row>
            <el-col :span="8">
              <el-form-item prop="jiaoshigonghao" label="教师工号">
                <el-input
                  class="list_inp"
                  v-model="userForm.jiaoshigonghao"
                  placeholder="教师工号"
                  readonly
                ></el-input>
              </el-form-item>
            ...
            <el-col :span="8">
              <el-form-item prop="jiaoshixingming" label="教师姓名">
                <el-input
                  class="list_inp"
                  v-model="userForm.jiaoshixingming"
                  placeholder="教师姓名"
                ></el-input>
              </el-form-item>
            </el-col>
...
const rules = ref({
  jiaoshigonghao: [{ required: true, message: '请输入', trigger: 'blur' }],
  mima: [{ required: true, message: '请输入', trigger: 'blur' }],
  jiaoshixingming: [{ required: true, message: '请输入', trigger: 'blur' }],
  touxiang: [],
