  ...
  >
    ...
    <div class="detail_view">
      ...
      <div class="info_view">
        ...
        <div class="info_item">
          <div class="info_label">教师意见</div>
          <div class="info_text">{{ detail.jiaoshiyijian }}</div>
        </div>
        <div class="info_item">
        ...
        <div class="btn_view">
          <el-button
            class="edit_btn"
            v-if="centerType && btnAuth('kaoshichengji', '修改')"
            type="primary"
            @click="editClick"
            >修改</el-button
          >
          <el-button
            class="del_btn"
            v-if="centerType && btnAuth('kaoshichengji', '删除')"
            type="danger"
            @click="delClick"
            >删除</el-button
          >
...
const getDetail = () => {
  context
    ...
    .then((res) => {
      title.value = res.data.data.kaoshimingcheng
